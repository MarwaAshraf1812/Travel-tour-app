...
function PackageDetails() {
  ...
  return (
    <div className="relative">
      <Navbar/>
      <AboutHero BigText={'Landscapes'} smallText={'Explore'} image={PackageDetailImage}/>
      <div className="relative -top-16 left-1/2 transform -translate-x-1/2 w-full max-w-7xl md:max-w-7xl bg-white shadow-lg z-40">
        <PackageNavbar setActiveTab={setActiveTab} ActiveTab={activeTab} />
        <div className="flex flex-col  lg:flex-row lg:space-x-6 p-8 my-8 justify-center items-center">
          ...
          <div className="w-full lg:w-[45%] flex flex-col md:flex md:flex-cols md:justify-center md:items-center items-end gap-y-8 md:gap-y-20 mt-8 md:mt-0">
            <BookingForm />
            <img src={Plane} alt="plane" className="w-full max-w-lg object-cover"/>
          </div>
        </div>
      </div>
      <Footer/>
