export default function PromotionCard(Props) {
  return (
    <div className="relative transform hover:scale-105 lg:w-[20%] lg:h-auto max-[500px]:w-[100%] xl:w-[18%] xl:h-auto md:w-[32%] rounded-lg overflow-hidden cursor-pointer shadow-lg flex items-center justify-center">
